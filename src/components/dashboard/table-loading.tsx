...
export default function Page() {
    ...
    const bodyTR = <>
        <tr className="px-2 border-b border-gray-300">
            <td className="flex flex-col md:flex-row items-center p-2 leading-none bg-gray-200">
                <div className="flex flex-col md:flex-row justify-center md:justify-start items-center w-full">
                    <div className="animate-pulse h-12 w-12 mx-1 bg-gray-400 shadow-md rounded-full"> </div>
